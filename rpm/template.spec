...
Name:           ros-kilted-etsi-its-ivim-ts-coding
Version:        3.5.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS etsi_its_ivim_ts_coding package

License:        MIT
URL:            https://index.ros.org/p/etsi_its_ivim_ts_coding/#kilted
...
%description
C++ compatible C source code for ETSI ITS IVIMs generated from ASN.1 using asn1c
