...
Name:           ros-kilted-etsi-its-ivim-ts-msgs
Version:        3.5.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS etsi_its_ivim_ts_msgs package

License:        MIT
URL:            https://index.ros.org/p/etsi_its_ivim_ts_msgs/#kilted
...
%description
ROS messages for ETSI ITS IVIM (TS)
